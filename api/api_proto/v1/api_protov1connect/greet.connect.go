...
const (
	...
	GreetServiceName = "api_proto.v1.GreetService"
)
...
const (
	...
	GreetServiceGreetProcedure = "/api_proto.v1.GreetService/Greet"
)

// GreetServiceClient is a client for the api_proto.v1.GreetService service.
type GreetServiceClient interface {
	Greet(context.Context, *v1.GreetRequest) (*v1.GreetResponse, error)
}

// NewGreetServiceClient constructs a client for the api_proto.v1.GreetService service. By default,
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	greetServiceMethods := v1.File_api_proto_v1_greet_proto.Services().ByName("GreetService").Methods()
...
// Greet calls api_proto.v1.GreetService.Greet.
...
// GreetServiceHandler is an implementation of the api_proto.v1.GreetService service.
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/api_proto.v1.GreetService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *v1.GreetRequest) (*v1.GreetResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api_proto.v1.GreetService.Greet is not implemented"))
}
